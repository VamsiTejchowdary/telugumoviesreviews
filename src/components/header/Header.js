    ...
    return (
        <div className="header">
            <div className="headerLeft">
                <Link to="/">
                    <img className="header__icon" src="tfilogo.png" alt="Logo" />
                </Link>
            </div>
            {/* Hamburger Menu Icon */}
            ...
            <div className={`menu ${isMenuOpen ? "open" : ""}`}>
                <Link to="/movies/popular" style={{ textDecoration: "none" }}>
                    <span onClick={() => setIsMenuOpen(false)}>Popular</span>
                </Link>
                <Link to="/movies/upcoming" style={{ textDecoration: "none" }}>
                    <span onClick={() => setIsMenuOpen(false)}>Upcoming</span>
                </Link>
                {/* Use Link but prevent navigation */}
                <Link to="#" onClick={toggleContactForm} style={{ textDecoration: "none" }}>
                    <span>Contact</span>
                </Link>
            </div>
